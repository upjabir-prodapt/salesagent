from src.services.research.agent.sales.prompts import (
    ALIGNMENT_PROMPT,
    CAMPAIGN_SIGNALS_PROMPT,
    FIRMOGRAPHICS_PROMPT,
    REPORT_COMPILER_PROMPT,
)
from src.services.research.agent.sales.prompts.company_prompts import (
    FIRMOGRAPHICS_PROMPT as COMPANY_FIRMOGRAPHICS_PROMPT,
)
from src.services.research.agent.sales.prompts.signal_prompts import (
    CAMPAIGN_SIGNALS_PROMPT as SIGNAL_CAMPAIGN_PROMPT,
)
from src.services.research.agent.sales.prompts.synthesis_alignment_prompts import (
    ALIGNMENT_PROMPT as MOD_ALIGNMENT_PROMPT,
)
from src.services.research.agent.sales.prompts.synthesis_report_prompts import (
