...
def test_create_sales_agent_app_structure(
    ...
    mock_sub_agents, 
    mock_signals_agent, 
    mock_synthesis_agents
):
    with patch("src.agents.salesAgent.agent.create_research_agents", return_value=mock_sub_agents), \
         patch("src.agents.salesAgent.agent.create_signals_orchestrator", return_value=mock_signals_agent), \
         patch("src.agents.salesAgent.agent.create_synthesis_agents", return_value=mock_synthesis_agents), \
