...
def test_create_signals_orchestrator():
    with patch("src.agents.salesAgent.sub_agents.signals_agent.create_llm_agent") as mock_factory, \
         patch("src.agents.salesAgent.sub_agents.signals_agent.ParallelAgent") as mock_parallel:
