...
@pytest.mark.asyncio
async def test_process_research_background_functional(
    research_service, mock_bq_repo, mock_gcs_repo
):
...
@pytest.mark.asyncio
async def test_process_research_background_pdf_failure_functional(
    research_service, mock_bq_repo, mock_gcs_repo
):
...
@pytest.mark.asyncio
async def test_process_research_background_eval_failure_functional(
    research_service, mock_bq_repo, mock_gcs_repo
):
...
async def test_get_pdf_report_functional(research_service, mock_bq_repo, mock_gcs_repo):
    ...
    mock_bq_repo.get_status.return_value = {
        "status": "COMPLETED",
        "company_name": "Acme",
    }
