...
from ..runtime.search_log import get_search_count, get_search_query_records
from ..runtime.telemetry import TELEMETRY_RECORDS_KEY
...
async def run_search_log_op(
    *,
    ...
    with_retry_sync(lambda: insert_search_query_batch(rows))
...
async def run_telemetry_flush_op(
    *,
    ...
    if not telemetry_records:
        return
    try:
        with_retry_sync(lambda: insert_agent_telemetry_batch(telemetry_records))
