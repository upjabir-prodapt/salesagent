...
from .errors import RETRY_SCOPE_NONE, resolve_retry_agents, retry_scope_for_error_class
...
def prepare_agents_retry(state: dict[str, Any], agent_names: list[str]) -> None:
    """Clear outputs and mark multiple agents for pipeline retry."""
    for agent_name in agent_names:
        prepare_agent_retry(state, agent_name)
