...
from ..agent.sales.utils.agent_factory import create_plan_react_agent
...
class PlanReActAgentFactory:
    ...
    @classmethod
    def build_research_lanes(cls) -> tuple[SequentialAgent, object, SequentialAgent, SequentialAgent, object]:
    ...
    def build_synthesis_agents():
        from ..agent.sales.sub_agents.synthesis_agents import create_synthesis_agents
