...
from ....domain.agent_contracts import get_output_key
...
from ..tools.output_persistence import persist_output_key
from ..tools.report_validation import VALIDATE_FINAL_REPORT_TOOL
from ..tools.search import COLT_PRODUCT_SEARCH_TOOL, SEARCH_AGENT_NAME
from ..tools.verification import PLANNER_TAG_RE, EvidenceStore
...
def _has_injection(text: str) -> bool:
    low = text.lower()
    patterns = _QUERY_INJECTION_PATTERNS + _PLAN_EXTRA_INJECTION_PATTERNS
